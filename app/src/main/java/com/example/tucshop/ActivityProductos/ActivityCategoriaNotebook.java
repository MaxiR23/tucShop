...
public class ActivityCategoriaNotebook extends AppCompatActivity {

    private FirebaseAuth firebaseAuth;
    List<Productos> productosList;
    ListaProductosAdapter adapter;
    private RecyclerView rvCN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_categoria_notebook);

        productosList = new ArrayList<>();
        rvCN = findViewById(R.id.rvCNotebook);
        rvCN.setHasFixedSize(true);
        rvCN.setNestedScrollingEnabled(false);
        rvCN.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void consultarProductos() {
        ...
        Query query = FirebaseDatabase.getInstance().getReference("Productos").orderByChild("categoria").equalTo("Notebook");
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    adapter = new ListaProductosAdapter(ActivityCategoriaNotebook.this, productosList);
                    adapter.notifyDataSetChanged();
                    rvCN.setAdapter(adapter);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId())
        {
            ...
            case R.id.opción_cerrar_sesión :
                ...
                Intent intent = new Intent(ActivityCategoriaNotebook.this, LoginActivity.class);
